...
timeseries <- master %>% filter(site %in% all.ts)
...
mul.ts.plot
#gg
gg.sites <- c("Glacier", "Glacier", "Glacier", "Landslide", "Landslide", "Landslide", "Wind", "Wind", "Wind")
...
ggsave("ulb.ts.png", plot = ulb.ts.plot, width = 7, height = 5, units = c("in"))
ggsave("mul.ts.png", plot = mul.ts.plot, width = 7, height = 5, units = c("in"))
ggsave("rmo.ts.png", plot = rmo.ts.plot, width = 7, height = 5, units = c("in"))
ggsave("gg.ts.png", plot = gg.ts.plot, width = 7, height = 5, units = c("in"))
